<html>
    <head>
        ...
        <title>PINTU</title>
        <meta data-n-head="ssr" data-hid="description" name="description" property="description" content="Pintu adalah Aplikasi Jual Beli dan Investasi Bitcoin dan Aset Digital dengan Harga Final, Tanpa Komisi, Tarik Rupiah Murah. Aman Terdaftar di BAPPEBTI.">
        <meta data-n-head="ssr" data-hid="og:url" name="og:url" property="og:url" content="https://pintu.co.id">
        <meta name="og:image" property="og:image" content="https://s3.ap-southeast-1.amazonaws.com/content.pintu.co.id/pintu_thumbnail_card_6a039be9aa.png">
        <meta data-n-head="ssr" data-hid="apple-mobile-web-app-title" name="apple-mobile-web-app-title" content="PINTU">
        <meta property="og:image" content="https://s3.ap-southeast-1.amazonaws.com/content.pintu.co.id/pintu_thumbnail_card_6a039be9aa.png">
        <meta data-n-head="ssr" data-hid="author" name="author" content="PINTU">
